            ...
            .UseContentRoot(Directory.GetCurrentDirectory())
               .ConfigureAppConfiguration((hostingContext, config) =>
               {
                   config
                       ...
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/azure.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/ocelot.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/storage.json", true, true)
                       ...
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/google_credential.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/google_firebase.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/smtp.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/payments.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/redis.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/log.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/rate_limit.json", true, true)
                       .AddJsonFile($"{MixAppSettingsFilePaths.Shared}/AppConfigs/portal.json", true, true)
